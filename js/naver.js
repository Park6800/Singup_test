...
function change_page(){
  ...
  if(lang_page == "en"){
    location.href="http://127.0.0.1:5500/html/naver_en.html"
  }
  else if(lang_page =="ko"){
    location.href="http://127.0.0.1:5500/html/naver.html"
  }
  else{
    location.href="http://127.0.0.1:5500/html/naver_jp.html"
  }
}
...
function chk_terms_func() {
  ...
  if(v_chk1==true){
    if(v_chk2==true){
      location.href="http://127.0.0.1:5500/html/input.html"
    }
    else{
